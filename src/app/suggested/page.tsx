...
export default function SuggestedPage() {
    ...
    try {
      ...
      const suggestions = allItems
        .filter(item => 
            ...
            !viewedItemIds.includes(item.id) &&      
  ...
  }, [suggestedItems, searchTerm, getItemTitleSubtitle]);
    ...
    if (items.length === 0) {
        return (
            <div className="col-span-full text-center py-12 text-muted-foreground">
                ...
                <h3 className="text-xl font-bold font-headline text-foreground">Not Enough Data For Suggestions</h3>
                <p>Browse some items to get personalized recommendations.</p>
            </div>
        )
    }
    return (
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:py-16">
      ...
      {renderAuctionGrid(filteredItems, areAllListingsLoading)}
    </div>
  );
}
